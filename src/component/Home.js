                    ...
                    <div className="col-xs-3">
                      <div className="container bootdey">
                        <div className="col-md-12 bootstrap snippets">
                          <div className="panel">
                            <img
                              className="profile-pic mr-1 my-1"
                              src="https://st.depositphotos.com/1137241/3726/i/600/depositphotos_37263133-stock-photo-bright-fashion-girl.jpg"
                              alt="post_img"
                            />
                    ...
                    <div className="col-xs-2">
                      <div className="containers">
                        ...
                        <div className="card-s">
                          <img
                            className="card-s__image card-s__images"
                            src="https://img.favpng.com/24/20/16/smile-tooth-dimple-face-png-favpng-hu7btEA1AwuwFzh8uJyrG0360.jpg"
                            alt="Person"
                          />

                          <div className="grid-container">
                            <div className="grid-child-posts">
                              <a className="mb-0 card-s__name" href="/">
                                Etey-Grace
                              </a>
                              <p className="mb-0 card-s-text">
                      ...
                      <div className="containers">
                        <div className="card-s">
                          <img
                            className="card-s__image card-s__images"
                            src="https://images.unsplash.com/photo-1560365163-3e8d64e762ef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fHNtaWxpbmclMjBmYWNlfGVufDB8fDB8fA%3D%3D&w=1000&q=80"
                            alt="Person"
                          />
                      ...
                      <div className="containers">
                        <div className="card-s">
                          <img
                            className="card-s__image card-s__images"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRE9kXu0mGB_nuM-wPsCYf9V1u8SZZBst1WKoBt82JDFt_cHBwg64qn4wYmVzLCZV5VnAw&usqp=CAU"
                            alt="Person"
                          />
                          <div className="grid-container">
                            <div className="grid-child-posts">
                      ...
                      <div className="containers">
                        <div className="card-s">
                          <img
                            className="card-s__image card-s__images"
                            src="https://www.pngall.com/wp-content/uploads/2016/04/Happy-Girl-Free-PNG-Image.png"
                            alt="Person"
                          />
                          <div className="grid-container">
                            <div className="grid-child-posts">
